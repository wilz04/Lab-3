...
# Este es un esqueleto de lo que idealmente debe hacer un tester. Idealmente, este modulo
# seria importado en un pset y corrido como su funcion principal. 

# Necesitamos las siguientes funciones rpc. (Generalmente toman numero de usuario y 
# palabra de paso, pero usted puede ajustar esto para cualquier sistema de seguridad.)
#
